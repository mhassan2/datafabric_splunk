...
printf "\033[1;34mThis [$scriptNAME] is the official method to stop hdfs. While you can still use this script, it is recommend that you use \033[0;32m/etc/init.d/hadoop [start|stop|restart]\033[0m \033[1;34m warpper script instead. All startup scritps in /etc/init.d has been modified to work with this container. "
