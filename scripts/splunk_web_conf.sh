...
custom_web_conf="[settings]\nlogin_content=<div align=\"right\" style=\"border:2px solid green;\"> $LINE1 $LINE2 $LINE3 $LINE4 $LINE5 $LINE6 $LINE7 $LINE8 $LINE9 $LINE10 $LINE11 </div> <p><font color="\#867979\#"> Data Fabric Integration Sandbox v$CONTAINER_VER &nbsp; (container internal IP=$container_ip)</font></p>\n\nenableSplunkWebSSL=0\n"
