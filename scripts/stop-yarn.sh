...
if [ -z "$parentNAME" ]; then
	printf "\033[1;34mThis script \033[0;32m$scriptNAME\033[1;34m is the official method to stop Yarn. While you can still use this script, it is recommend that you use \033[0;32m/etc/init.d/yarn [start|stop|restart]\033[0m \033[1;34m warpper script instead. All startup scritps in /etc/init.d has been modified to work with this container. "
